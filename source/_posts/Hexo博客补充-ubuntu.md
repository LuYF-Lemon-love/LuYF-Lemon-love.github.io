...
30. [公安备案流程](https://cloud.tencent.com/document/product/243/19142)

31. [公安备案常见问题](https://cloud.tencent.com/document/product/243/19616)
...
48. [Hexo增添头像卡片动态背景](https://cnhuazhu.top/butterfly/2021/02/24/Hexo%E9%AD%94%E6%94%B9/Hexo%E5%A2%9E%E6%B7%BB%E5%A4%B4%E5%83%8F%E5%8D%A1%E7%89%87%E5%8A%A8%E6%80%81%E8%83%8C%E6%99%AF/)

49. [Hexo博客Butterfly主题美化](https://www.tqwba.com/x_d/jishu/298102.html)

50. [Math 数学](https://butterfly.js.org/posts/ceeb73f/#Math-%E6%95%B8%E5%AD%B8)

51. [npm install 安装依赖无反应](https://blog.csdn.net/ks8380/article/details/107614263)

52. [MarkDown数学公式基本语法](https://blog.csdn.net/qq_38342510/article/details/124064158)

53. [Supported Functions](https://katex.org/docs/supported.html)

54. [Support Table](https://katex.org/docs/support_table.html)
...
![](https://cos.luyf-lemon-love.space/images/20220601162101.png)
...
![](https://cos.luyf-lemon-love.space/images/20220602221758.png)
...
![](https://cos.luyf-lemon-love.space/images/20220602223237.png)
...
![](https://cos.luyf-lemon-love.space/images/20220603212433.png)

{% label 开通POP3/SMTP服务 pink %}

以 QQ 邮箱为例，登录 QQ 邮箱 > 设置 > 账号 > POP3/IMAP/SMTP/Exchange/CardDAV/CalDAV服务，开启 POP3/SMTP 服务

![](https://cos.luyf-lemon-love.space/images/20220603230320.png)

需要用 QQ 绑定的手机发送短信，获得授权码（{% label 需要留存，后面要用 green %}）。

进入你的博客的评论区，点击右下角的设置按钮，注册账号并登录，你就可以配置你的评论区了。

![](https://cos.luyf-lemon-love.space/images/20220603230715.png)

![](https://cos.luyf-lemon-love.space/images/20220603230840.png)
...
![](https://cos.luyf-lemon-love.space/images/20220603231854.png)
...
![](https://cos.luyf-lemon-love.space/images/20220603232406.png)

拉到最下方点击保存后，打开邮件通知测试，输入你的邮箱，点击发送测试邮件，如果能成功收到邮件即说明邮件通知服务设置成功！

然后用其他的 QQ 在你的博客的评论区评论，你会收到邮件通知。

![](https://cos.luyf-lemon-love.space/images/20220603232733.png)

![](https://cos.luyf-lemon-love.space/images/20220603232805.png)

{% label 按语言的代码高亮 pink %}

Twikoo 管理面板 > 插件，如下图设置，点击保存。

![](https://cos.luyf-lemon-love.space/images/20220604150346.png)
...
![](https://cos.luyf-lemon-love.space/images/20220604150045.png)

{% label 效果 pink %}

![](https://cos.luyf-lemon-love.space/images/20220604150307.png)

{% label 显示用户系统、浏览器和用户IP到省 pink %}

Twikoo 管理面板 > 隐私，如下图设置，点击保存。

![](https://cos.luyf-lemon-love.space/images/20220605223433.png)

{% label 设置前 pink %}

![](https://cos.luyf-lemon-love.space/images/20220605223743.png)

{% label 设置后(需要新添一个评论，刷新评论系统) pink %}

![](https://cos.luyf-lemon-love.space/images/20220605223926.png)
...
![](https://cos.luyf-lemon-love.space/images/20220604213335.png)

{% label 效果 pink %}

![](https://cos.luyf-lemon-love.space/images/20220605115803.png)
...
![](https://cos.luyf-lemon-love.space/images/20220606132725.png)
...
![](https://cos.luyf-lemon-love.space/images/20220606133203.png)

![](https://cos.luyf-lemon-love.space/images/20220606133301.png)
...
![](https://cos.luyf-lemon-love.space/images/20220606150628.png)
...
![](https://cos.luyf-lemon-love.space/images/20220606150933.png)

![](https://cos.luyf-lemon-love.space/images/20220606151008.png)
...
![](https://cos.luyf-lemon-love.space/images/20220606161522.png)

{% label 修改后 pink %}

![](https://cos.luyf-lemon-love.space/images/20220606161608.png)
...
![](https://cos.luyf-lemon-love.space/images/20220606164848.png)

{% label 效果 pink %}

![](https://cos.luyf-lemon-love.space/images/20220606164945.png)
...
![](https://cos.luyf-lemon-love.space/images/20220606184048.png)

![](https://cos.luyf-lemon-love.space/images/20220606184259.png)
...
![](https://cos.luyf-lemon-love.space/images/20220607220645.png)
...
![](https://cos.luyf-lemon-love.space/images/20220607222452.png)

![](https://cos.luyf-lemon-love.space/images/20220607222739.png)
...
![](https://cos.luyf-lemon-love.space/images/20220607222928.png)
...
![](https://cos.luyf-lemon-love.space/images/20220607224623.png)

![](https://cos.luyf-lemon-love.space/images/20220607224351.png)

![](https://cos.luyf-lemon-love.space/images/20220607224314.png)

{% label 腾讯云域名绑定到Vercel上 pink %}

1. 登录 [Vercel](https://vercel.com/dashboard) 

![](https://cos.luyf-lemon-love.space/images/20220607230608.png)

2. 进入到部署博客的项目

![](https://cos.luyf-lemon-love.space/images/20220607230751.png)

3. 点击 Settings > Domains

![](https://cos.luyf-lemon-love.space/images/20220607230912.png)

4. 添加域名，我一共添加了两个自定义域名，分别为：`vercel.luyf-lemon-love.space` 和 `www.vercel.luyf-lemon-love.space`，每一次，点击 add 后，在下方会出现一组解析记录。

![](https://cos.luyf-lemon-love.space/images/20220607232424.png)

![](https://cos.luyf-lemon-love.space/images/20220607231009.png)

![](https://cos.luyf-lemon-love.space/images/20220607231302.png)

5. 到腾讯云的 DNSPod 控制台，添加解析记录（Vercel 自带 SSL 证书，无需申请）。

![](https://cos.luyf-lemon-love.space/images/20220607231520.png)

![](https://cos.luyf-lemon-love.space/images/20220607231601.png)
...
![](https://cos.luyf-lemon-love.space/images/20220608124225.png)

![](https://cos.luyf-lemon-love.space/images/20220608124257.png)
...
![](https://cos.luyf-lemon-love.space/images/20220608140247.png)
...
![](https://cos.luyf-lemon-love.space/images/20220608125059.png)
...
![](https://cos.luyf-lemon-love.space/images/20220608134227.png)
...
![](https://cos.luyf-lemon-love.space/images/20220608134402.png)

10. HTTP 自动跳转 HTTPS 的安全配置（可选），请在弹出的 “站点修改” 窗口，单击开启强制 HTTPS 即可完成配置。如下图所示：

![](https://cos.luyf-lemon-love.space/images/20220608134822.png)
...
![](https://cos.luyf-lemon-love.space/images/20220611153256.png)
...
![](https://cos.luyf-lemon-love.space/images/20220611154313.png)

4. 点击 Download Code，下载到本地。解压压缩包，里面的文件如图

![](https://cos.luyf-lemon-love.space/images/20220611154736.png)
...
![](https://cos.luyf-lemon-love.space/images/20220611155114.png)
...
![](https://cos.luyf-lemon-love.space/images/20220611172304.png)

Github Pages 配置如下：

![](https://cos.luyf-lemon-love.space/images/20220611172545.png)

![](https://cos.luyf-lemon-love.space/images/20220611172640.png)

Vercel Domains：

![](https://cos.luyf-lemon-love.space/images/20220611172758.png)

![](https://cos.luyf-lemon-love.space/images/20220611172906.png)

![](https://cos.luyf-lemon-love.space/images/20220611173051.png)
...
公安备案审核通过后，您需在30日内登录 [全国公安机关互联网站安全管理服务平台](http://www.beian.gov.cn/portal/index)，在您的已备案网站详情中，复制网站公安机关备案号，下载备案编号图标，复制备案编号 HTML 代码，并编辑您的网页源代码。

公安备案的流程请参考腾讯云官方文档——[公安备案流程](https://cloud.tencent.com/document/product/243/19142)

#### 操作步骤

{% label 注册与登录 pink %}

1. 在 [全国公安机关互联网站安全管理服务平台](http://www.beian.gov.cn/)， 单击联网备案登录。
...
{% label 填写开办者主体信息 pink %}

1. 在弹出的 “系统提示” 窗口中，单击进入。如下图所示，若系统未自动提示，请您单击主页页签，即可提示您填写开办主体信息。

![](https://cos.luyf-lemon-love.space/images/20220613134711.png)

2. 在 “网站开办主体” 页面，根据实际需求，选择开办主体性质。

3. 根据页面提示逐步操作。由于我们要为个人博客公安备案，“开办主体性质” 选择为 “个人”：填写 “开办者信息”，单击提交审核。注：地址一定填写要常住地址。

{% label 填写新办网站信息 pink %}

1. 在左侧导航栏中，单击新办网站申请，进入 “新办网站申请” 页面。如下图所示：

![](https://cos.luyf-lemon-love.space/images/20220613135356.png)

2. 确认网站开办主体信息无误，单击下一步。

3. 根据页面提示，填写网站基本信息，并单击下一步。

|主要参数|详细信息|
|:-:|:-:|
|网站信息|1. 网站开通日期：首次备案通过日期。您可在 [工信部网站](https://beian.miit.gov.cn/#/Integrated/index) 页面输入域名、单位名称或备案号关键字，单击搜索查询审核通过时间。2. 域名证书：腾讯云域名证书获取请参考 [证书下载](https://cloud.tencent.com/document/product/242/3647)，其它服务商请前往服务商域名管理后台获取。3. 从域名：能访问该网站的其它域名。4. IP：填写您备案云服务器的 IP 地址。|
...
4. 根据页面提示，填写网站负责人信息，并单击下一步。由于我们 “开办主体性质” 为 “个人”，可直接勾选同主体负责人后会自动填入。

{% label 同意责任书并提交审核 pink %}
...
![](https://cos.luyf-lemon-love.space/images/20220613145146.png)

3. 在弹出的 “域名证书” 窗口中，单击下载证书，选择下载路径，保存证书。如下图所示：

![](https://cos.luyf-lemon-love.space/images/20220613145358.png)
...
![](https://cos.luyf-lemon-love.space/images/20220613155406.png)

![](https://cos.luyf-lemon-love.space/images/20220613155513.png)

![](https://cos.luyf-lemon-love.space/images/20220613155716.png)

![](https://cos.luyf-lemon-love.space/images/20220613155910.png)

2. 点击 点击下载备案编号图标 下载图标，点击 点击复制备案编号HTML代码 得到HTML代码。

![](https://cos.luyf-lemon-love.space/images/20220613160253.png)

![](https://cos.luyf-lemon-love.space/images/备案图标.png)
...
{% span cyan, 最终的费用为存储容量费用 + CDN回源流量费用（CDN回源流量包） + CDN下行流量（CDN流量包）+ 请求费用 %}

---

个人用户每月享受50GB标准存储容量，6个月，详情请参见 [免费额度](https://cloud.tencent.com/document/product/436/6240)。

![](https://cos.luyf-lemon-love.space/images/20220614114837.png)

![](https://cos.luyf-lemon-love.space/images/20220611171516.png)

![](https://cos.luyf-lemon-love.space/images/20220614115349.png)

![](https://cos.luyf-lemon-love.space/images/20220614120104.png)
...
![](https://cos.luyf-lemon-love.space/images/20220614122756.png)
...
腾讯云 COS 搭建图床的教程请参考 {% post_link PicGo-腾讯云COS搭建图床-ubuntu %}
...
偶然间发现 Bing 竟然收录了我的博客，但是我并没有向其添加站点。因此我看了看 Google 和 Baidu，发现它们也都收录我的博客。但是不幸的是之前向百度提交的站点，并没有被百度收录（`site:lu-yf-lemon-love-github-io.vercel.app`）。
...
![](https://cos.luyf-lemon-love.space/images/20220617122935.png)

![](https://cos.luyf-lemon-love.space/images/20220617123017.png)

![](https://cos.luyf-lemon-love.space/images/20220617123114.png)

![](https://cos.luyf-lemon-love.space/images/20220617123147.png)

![](https://cos.luyf-lemon-love.space/images/20220617123217.png)

![](https://cos.luyf-lemon-love.space/images/20220617123314.png)

![](https://cos.luyf-lemon-love.space/images/20220617123340.png)

![](https://cos.luyf-lemon-love.space/images/20220617123420.png)

### 增添头像卡片动态背景

原教程链接：[Hexo增添头像卡片动态背景](https://cnhuazhu.top/butterfly/2021/02/24/Hexo%E9%AD%94%E6%94%B9/Hexo%E5%A2%9E%E6%B7%BB%E5%A4%B4%E5%83%8F%E5%8D%A1%E7%89%87%E5%8A%A8%E6%80%81%E8%83%8C%E6%99%AF/)

本节将介绍如何在侧边栏增添头像卡片动态背景。效果展示：将鼠标移至头像卡片即可看到。

在 blog/themes/butterfly/source/css/_custom 目录中创建 my_avatar.css 文件，粘贴下面代码。_custom 目录的作用及使用方法请参考 {% post_link Hexo快速搭建一个博客-ubuntu %} 中的 `Hexo 异步加载方案` 小节。
...
![](https://cos.luyf-lemon-love.space//images/2022-06-22-12-59-53屏幕截图.png)

### 公告板图片

原教程链接：[Hexo博客Butterfly主题美化](https://www.tqwba.com/x_d/jishu/298102.html)
...
![](https://cos.luyf-lemon-love.space//images/20220622130255.png)
