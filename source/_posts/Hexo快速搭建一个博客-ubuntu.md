...
```
1. 前往 LeanCloud(https://console.leancloud.cn/) ，注册账号。
...
```
lu-yf-lemon-love-github-io.vercel.app/baidusitemap.xml
lu-yf-lemon-love-github-io.vercel.app/sitemap.xml
```

7. 百度收录很慢，一般至少要半个月，你可以半个月后到百度搜索引擎中输入 site:<域名>（site:lu-yf-lemon-love-github-io.vercel.app)看看又没有收录。
